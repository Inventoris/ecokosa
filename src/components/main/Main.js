  ...
  return (
    <main className="main">
      ...
      <section className="main__mission">
        ...
        <p className="main__mission-message">ЭкоКоса — это некоммерческий open-source проект, призванный помочь туристам правильно и интересно посетить национальный парк «Куршская коса».</p>
      </section>
    </main>
  )
}
